    ...
    : BaseActivity(Name)
{
        ...
        FunctionContext context)
    {
        ...
        // ToDo, experiment with the extraction prompt and the model object below to tailor it to the needs of your specific documents.
        ...
        return await documentDataExtractor.FromByteArrayAsync<InvoiceData>(
            blobContentStream.ToArray(),
            "Extract all the data from the pages. If a value is not present, provide null.");
    }
